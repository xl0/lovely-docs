...
[SvelteKit](https://shadcn-svelte.com/docs/installation/sveltekit)

[Astro](https://shadcn-svelte.com/docs/installation/astro)

[Vite](https://shadcn-svelte.com/docs/installation/vite)
...
You can update your components to use the new dark mode colors by re-adding your components using the CLI[1](#user-content-fn-1).
...
Update the dark mode colors in your `app.css` file to the new OKLCH values. See the [Base Colors](https://shadcn-svelte.com/docs/theming#base-colors) reference for a list of colors.
